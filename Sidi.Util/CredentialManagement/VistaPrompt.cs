...
{
    internal class VistaPrompt: BaseCredentialsPrompt
    {
        string _domain;
        ...
        public override bool GenericCredential
        {
            get
            {
                CheckNotDisposed();
        ...
        public override DialogResult ShowDialog(IntPtr owner)
        {
            ...
            if (result)
            {
                ...
                SecurePassword = SecureStringHelper.CreateSecureString(passwordBuffer.ToString());
        ...
        public Credential Credential
        {
            get
            {
                return new Credential(this.Username, this.SecurePassword, this.Title);
            }
        }
    }
}
