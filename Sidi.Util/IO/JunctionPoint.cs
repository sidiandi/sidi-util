...
namespace Sidi.IO
{
    ...
    public static class JunctionPoint
    {
        ...
        private static SafeFileHandle OpenReparsePoint(LPath reparsePoint, EFileAccess accessMode)
        {
            var reparsePointHandle = new SafeFileHandle(CreateFile(reparsePoint.Param, accessMode,
